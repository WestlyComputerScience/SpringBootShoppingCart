...
import com.johnteacher.shoppingcart.request.LoginRequest;
import com.johnteacher.shoppingcart.response.ApiResponse;
import com.johnteacher.shoppingcart.response.JwtResponse;
import com.johnteacher.shoppingcart.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    // need to make sure the login request is validated (we specified @NotBlank in LoginRequest)
    @PostMapping("/login")
