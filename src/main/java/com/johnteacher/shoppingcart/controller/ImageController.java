...
import com.johnteacher.shoppingcart.service.image.IImageService;
...
@RequestMapping("${api.prefix}/images") // sets base URL for all endpoints in class
public class ImageController {
    private final IImageService imageService;

    @PostMapping("/upload") // used for creating/uploading data
    ...
    @GetMapping("image/download/{imageId}") // retrieves data
    ...
    @PutMapping("image/{imageId}/update") // updating existing resources
    ...
    /* === Additional Notes ===
        @RequestParam = extracts query params or form-data
